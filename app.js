...
/* to ensure we can not modify the object */
Object.freeze(myFavoriteFootballTeam);

/*Accessing the object properties by object destructuring*/
...
/**
 * Sets the player cards in the HTML element with the id "playerCards".
 * @param {Array} arr - An array of player objects.
 */
const setPlayerCards = (arr = players) => {
  ...
  <p>Number: ${number}</p>
  <p>Nickname: ${nickname !== null ? nickname : "N/A"}
  </div>
  </p>`
    )
    .join("");
...
playersDropdownList.addEventListener("change", (e) => {
  ...
  switch (e.target.value) {
    case "nickname":
      ...
      break;
    case "captain":
      setPlayerCards(players.filter((player) => player.isCaptain));
      break;
    case "defender":
      setPlayerCards(
